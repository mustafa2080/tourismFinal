...
# Header logo: transparent icon-only mark, tall enough for crisp @2x/@3x rendering
# at the header's max display height (h-14 = 56px on desktop).
target_h = 280
...
# Also refresh public/logo.png (used elsewhere, e.g. footer/meta) with same icon
header_logo.save(rf"{PUB}\logo.png")
print("saved public/logo.png", header_logo.size)

# Favicons from the same clean icon (simplified, sharpened at small sizes)
