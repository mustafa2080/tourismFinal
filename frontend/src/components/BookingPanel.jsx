...
const BookingPanel = ({
  ...
  return (
    <div className="h-fit sticky top-20 lg:top-20 space-y-4">
      ...
      {/* Price Card */}
      <div className="bg-[#14b8a6] rounded-xl p-6 border-2 border-teal-300 dark:border-teal-600 shadow-lg">
        <div className="space-y-6">
          ...
          <Button
            ...
            className="w-full bg-[#14b8a6] text-white font-bold py-3 rounded-lg"
          >
            Book Now
          </Button>
        </div>
