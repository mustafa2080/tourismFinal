...
const AdvancedPagination = ({
  ...
  return (
    <div className={`space-y-6 ${className}`}>
      ...
      {showItemsInfo && totalItems > 0 && (
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 px-4 py-3 bg-[#0d9488] rounded-lg border border-teal-200 dark:border-slate-600">
 ...
 page === currentPage
 ? 'bg-[#0d9488] text-white shadow-lg shadow-teal-400/50 scale-110'
 : page === '...'
