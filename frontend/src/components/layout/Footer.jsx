...
const Footer = () => {
  ...
  return (
    <footer className="bg-slate-950 dark:bg-slate-950 text-slate-100 mt-24">
      ...
      <div className="relative overflow-hidden">
        {/* Animated Background */}
        <div className="absolute inset-0 bg-[#14b8a6] opacity-90"></div>
 ...
 >
 <div className="w-9 h-9 bg-[#14b8a6] rounded-lg flex items-center justify-center group-hover:shadow-md transition-all group-hover:scale-110 border border-teal-500/20">
 <FiPhone size={16} />
 </div>
 ...
 <div
 key={method.name}
 className="px-3 py-2 bg-slate-800 hover:bg-[#14b8a6] rounded-lg text-xs text-slate-300 font-semibold hover:text-white transition-all hover:scale-110 border border-slate-700 hover:border-teal-500/50 flex items-center gap-1.5 cursor-default"
 title={method.name}
 >
