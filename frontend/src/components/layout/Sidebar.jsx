...
const Sidebar = ({ isAdmin = false }) => {
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 lg:hidden p-3 rounded-full bg-[#0d9488] text-white shadow-lg hover:shadow-xl transition-all"
 ...
 ? 'bg-[#0d9488] text-teal-600 dark:text-teal-400 border-l-2 border-teal-600'
