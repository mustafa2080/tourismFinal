...
const PackageDetailPage = () => {
        ...
        <div className="relative h-[350px] sm:h-[450px] lg:h-[550px] bg-black overflow-hidden group">
          ...
          {currentImage && (
            <div className="absolute inset-0">
              ...
              />
              <div className="absolute inset-0 bg-[#0d9488] " />
            </div>
          )}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              {displayPkg.highlights && displayPkg.highlights.length > 0 && (
                <div className="bg-[#0d9488] rounded-xl p-6 border border-teal-200 dark:border-teal-700">
 ...
 <div className="flex gap-3 p-4 bg-[#0d9488] rounded-lg border border-yellow-200 dark:border-yellow-700">
 {[1, 2, 3, 4, 5].map(star => (
 <button
 key={star}
                              ...
                              <button
                                ...
                                className={`w-full px-6 py-4 rounded-lg font-bold text-white transition-all duration-200 transform ${
                                  submitReviewLoading
                                    ...
                                    : 'bg-[#0d9488] active:scale-95 shadow-lg hover:shadow-xl'
 }`}
 >
 ...
 <div key={idx} className="bg-[#0d9488] rounded-lg p-5 border-l-4 border-yellow-400 hover:shadow-lg transition-all duration-200">
 ...
 {(review.user?.name || 'A')[0]}
                          ...
                          <div className="text-center py-12 bg-[#0d9488] rounded-lg border-2 border-dashed border-slate-300 dark:border-slate-600">
