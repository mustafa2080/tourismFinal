      ...
      <section className="relative pt-12 md:pt-20 pb-16 md:pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 dark:text-white mb-6">
            {t('contactPage.heroTitle')} <span className="bg-primary-600 bg-clip-text text-transparent">Voyager Tours</span>
          </h1>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 mb-16">
            {contactInfo.map((info, index) => {
              ...
              return (
                ...
                >
                  <div className={`w-14 h-14 rounded-lg bg-primary-600 ${info.color} flex items-center justify-center mb-4`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="space-y-4 sm:space-y-6">
              {/* Business Hours */}
              <div className="bg-primary-600 rounded-xl p-6 border border-teal-200 dark:border-slate-700">
              ...
              {/* Response Time */}
              <div className="bg-primary-600 rounded-xl p-6 border border-green-200 dark:border-slate-700">
              ...
              {/* Newsletter */}
              <div className="bg-primary-600 rounded-xl p-6 border border-orange-200 dark:border-slate-700">
