...
const ContactPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#14b8a6] flex flex-col">
      ...
      <section className="relative pt-12 md:pt-20 pb-16 md:pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 dark:text-white mb-6">
            {t('contactPage.heroTitle')} <span className="bg-[#14b8a6] bg-clip-text text-transparent">Voyager Tours</span>
          </h1>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 mb-16">
            {contactInfo.map((info, index) => {
              ...
              return (
                ...
                >
                  <div className={`w-14 h-14 rounded-lg bg-[#14b8a6] ${info.color} flex items-center justify-center mb-4`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="md:col-span-2 bg-white dark:bg-slate-800 rounded-xl p-6 sm:p-8 shadow-sm border border-slate-200 dark:border-slate-700">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full px-6 py-3 bg-[#14b8a6] text-white font-semibold rounded-lg transition-all hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 group"
                >
                  {isSubmitting ? (
                    <>
            ...
            <div className="space-y-4 sm:space-y-6">
              {/* Business Hours */}
              <div className="bg-[#14b8a6] rounded-xl p-6 border border-teal-200 dark:border-slate-700">
              ...
              {/* Response Time */}
              <div className="bg-[#14b8a6] rounded-xl p-6 border border-green-200 dark:border-slate-700">
              ...
              {/* Newsletter */}
              <div className="bg-[#14b8a6] rounded-xl p-6 border border-orange-200 dark:border-slate-700">
                ...
                <button className="w-full px-4 py-2 bg-[#14b8a6] text-white font-semibold rounded-lg transition-all">
      ...
      {/* CTA Section */}
      <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-[#14b8a6] ">
