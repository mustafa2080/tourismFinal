...
const AdminSetupPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#14b8a6] flex items-center justify-center p-4 sm:p-6 lg:p-8">
      {/* Animated Background */}
          ...
          <div className="text-center space-y-4">
            ...
            <div className="flex justify-center">
              <div className="relative">
                <div className="absolute inset-0 bg-[#14b8a6] rounded-full blur-lg opacity-75"></div>
                <div className="relative w-16 h-16 bg-[#14b8a6] rounded-full flex items-center justify-center">
 ...
 s <= step ? 'bg-[#14b8a6] w-8' : 'bg-slate-600 w-2'
 }`}
                ></div>
              ))}
            </div>
          ...
          {step === 1 && (
            <form onSubmit={handleVerifyAccessCode} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full py-3 bg-[#14b8a6] text-white font-bold rounded-xl transition-all duration-300 flex items-center justify-center gap-2 group"
              >
                Verify Code
          ...
          {step === 2 && (
            <form onSubmit={handleCreateAdmin} className="space-y-4 max-h-96 overflow-y-auto pr-2">
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  type="submit"
                  className="flex-1 py-3 bg-[#14b8a6] text-white font-bold rounded-xl transition-all duration-300 flex items-center justify-center gap-2 group"
                >
                  Continue
                  <FiArrowRight className="group-hover:translate-x-1 transition-transform" />
                </button>
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  disabled={loading}
                  className="flex-1 py-3 bg-[#14b8a6] text-white font-bold rounded-xl transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-50 group"
                >
                  {loading ? (
                    <>
