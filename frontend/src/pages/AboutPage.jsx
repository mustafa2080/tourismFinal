        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 dark:text-white mb-6 leading-tight">
              {t('aboutPage.heroTitle')} <span className="bg-[#14b8a6] bg-clip-text text-transparent">Voyager Tours</span>
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-6 py-3 bg-[#14b8a6] text-white font-semibold rounded-lg transition-all hover:shadow-lg group"
              >
            ...
            <div className="relative">
              <div className="w-full bg-[#14b8a6] rounded-2xl p-8 text-center text-white">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {values.map((value, index) => {
              ...
              return (
                ...
                >
                  <div className={`w-14 h-14 rounded-lg bg-[#14b8a6] ${value.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
            {team.map((member, index) => (
              <div
                key={index}
                className="bg-[#14b8a6] rounded-xl p-6 text-center hover:shadow-lg transition-all"
              >
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="bg-[#14b8a6] rounded-2xl p-8 text-white">
