...
const HomePage = () => {
 ...
 : 'w-2.5 h-2.5 bg-white/60 hover:bg-white/80 shadow-md'
              ...
              <StaggerGroup key={`grid-${i18n.language}`} className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2 xs:gap-3 sm:gap-4 md:gap-5 lg:gap-6">
                {translatedFeaturedPackages.map((translatedPkg, idx) => {
                  ...
                  return (
                    ...
                    >
                      {/* Image */}
                      <div className="relative h-36 xs:h-44 sm:h-52 md:h-56 bg-primary-600 overflow-hidden group">
                        ...
                        <div className="absolute inset-x-0 bottom-0 h-16 bg-primary-600 pointer-events-none" />
                        {/* Top gradient so badges stay legible on light images */}
                        <div className="absolute inset-x-0 top-0 h-16 bg-primary-600 pointer-events-none" />
      ...
      {/* ==================== STATISTICS ==================== */}
      <section className="py-6 sm:py-8 md:py-12 lg:py-20 bg-primary-600" style={{ display: 'block', visibility: 'visible', minHeight: '150px' }}>
              ...
              <StaggerGroup className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-5 lg:gap-6">
                {topReviews.map((review, idx) => {
                  ...
                  return (
                    ...
                    <Card
                      className="group relative overflow-hidden bg-primary-600 border border-slate-200 dark:border-slate-700 hover:border-teal-300 dark:hover:border-teal-500 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2"
                    >
 ...
 : 'text-slate-300 dark:text-slate-600'
                        ...
                        {/* Divider */}
                        <div className="h-px bg-primary-600"></div>
      ...
      <section className="py-6 sm:py-8 md:py-16 lg:py-32 bg-primary-600 relative" style={{ display: 'block', visibility: 'visible', minHeight: '200px' }}>
        ...
        <div className="w-full max-w-7xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="text-center mb-12 md:mb-20 space-y-3 md:space-y-4">
            <div className="inline-block">
              <Badge className="bg-primary-600 text-orange-700 dark:text-orange-300 mb-4 px-4 py-2 rounded-full text-xs md:text-sm font-bold border border-orange-300/30 dark:border-orange-700/30">
                ⭐ CLIENT TESTIMONIALS
              </Badge>
            </div>
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black bg-clip-text text-transparent bg-primary-600 leading-tight">
              ...
              topReviews.map((review, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-primary-600 transition-all duration-500 -z-0"></div>
 ...
 : 'text-slate-300 dark:text-slate-600'
                        ...
                        <div className="w-8 h-8 rounded-full bg-primary-600 flex items-center justify-center text-white text-xs font-bold opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                          ✓
                        </div>
                      </div>

                      {/* Quote Icon */}
                      <div className="inline-flex w-8 md:w-10 h-8 md:h-10 rounded-lg bg-primary-600 items-center justify-center mb-3 md:mb-4 text-orange-600 dark:text-orange-300 text-lg md:text-xl group-hover:scale-110 transition-transform duration-300">
                        "
                      </div>
                      ...
                      {/* Divider */}
                      <div className="my-4 md:my-6 h-1 bg-primary-600 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>

                      {/* Author Info */}
                      <div className="flex items-center gap-3 md:gap-4 pt-2">
                        <div className="w-10 md:w-12 h-10 md:h-12 rounded-full bg-primary-600 flex items-center justify-center text-white text-xs md:text-sm font-bold shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-110 flex-shrink-0">
                          {initials}
                        </div>
                        <div className="flex-1 min-w-0">
 ...
 : 'text-slate-300 dark:text-slate-600'
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 md:gap-5 lg:gap-6 mt-8 md:mt-12 lg:mt-16">
            <div className="text-center p-3 xs:p-4 sm:p-6 md:p-8 bg-white dark:bg-slate-800/50 rounded-xl sm:rounded-2xl border border-slate-200 dark:border-slate-700 hover:border-orange-300 dark:hover:border-orange-500 transition-all hover:shadow-lg group">
              <div className="text-xl xs:text-2xl sm:text-3xl md:text-4xl font-black bg-clip-text text-transparent bg-primary-600 mb-1 md:mb-2 group-hover:scale-110 transition-transform duration-300">
                4.9
              </div>
      ...
      {/* ==================== FINAL CTA ==================== */}
      <section className="py-8 sm:py-12 md:py-16 lg:py-24 bg-primary-600 relative overflow-hidden" style={{ display: 'block', visibility: 'visible', minHeight: '150px' }}>
        <motion.div
        ...
        <div className="w-full max-w-7xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex flex-col xs:flex-row gap-3 xs:gap-4 justify-center">
            <Button
              onClick={() => navigate('/search')}
              className="bg-primary-600 text-white font-bold px-6 xs:px-8 md:px-10 py-2.5 xs:py-3 rounded-full flex items-center justify-center gap-2 group transition-all shadow-lg text-sm xs:text-base"
            >
              <FiSearch size={16} />
              <span>Explore Now</span>
            </Button>
