          ...
          <div className="max-w-md mx-auto px-4">
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-2xl text-center animate-in fade-in slide-in-from-bottom-4">
              <div className="flex justify-center mb-6">
                <div className="relative w-20 h-20 bg-[#0d9488] rounded-full flex items-center justify-center shadow-lg">
              ...
              <button
                ...
                className="w-full py-3 px-4 rounded-xl font-bold text-white bg-[#0d9488] transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl"
              >
                Back to Login
              </button>
            </div>
