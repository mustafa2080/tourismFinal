      ...
      <MainLayout>
        <div className="relative min-h-screen w-full overflow-hidden pt-20 pb-12">
          <div className="absolute inset-0 -z-10">
            ...
            <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-br from-orange-500/20 via-pink-500/20 to-red-500/20 rounded-full blur-3xl animate-pulse" />
          </div>
          ...
          <div className="max-w-md mx-auto px-4 flex items-center justify-center min-h-[calc(100vh-200px)]">
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-2xl text-center">
              <FiLoader className="w-12 h-12 animate-spin text-teal-600 mx-auto mb-4" />
          ...
          <div className="max-w-md mx-auto px-4 flex items-center justify-center min-h-[calc(100vh-200px)]">
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-2xl text-center">
              ...
              <button
                ...
                className="w-full py-3 px-4 rounded-xl font-bold text-white bg-gradient-to-r from-teal-600 to-orange-600 hover:from-teal-700 hover:to-orange-700 transition-all"
              >
                Request New Link
              </button>
            </div>
        ...
        <div className="relative min-h-screen w-full overflow-hidden pt-20 pb-12">
          ...
          <div className="max-w-md mx-auto px-4 flex items-center justify-center min-h-[calc(100vh-200px)]">
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-2xl text-center animate-in fade-in">
              <div className="w-20 h-20 bg-gradient-to-br from-green-400 to-teal-500 rounded-full flex items-center justify-center shadow-lg mx-auto mb-6">
              ...
              <button
                ...
                className="w-full py-3 px-4 rounded-xl font-bold text-white bg-gradient-to-r from-teal-600 to-orange-600 hover:from-teal-700 hover:to-orange-700 transition-all flex items-center justify-center gap-2"
              >
            ...
            <div className="hidden lg:flex flex-col justify-center space-y-8 animate-in fade-in slide-in-from-left-8 duration-700">
              ...
              <div className="space-y-4">
                ...
                {[
                  ...
                  <div key={idx} className="flex gap-3 p-3 rounded-lg bg-teal-50 dark:bg-teal-900/20">
                    <span className="text-teal-600 dark:text-teal-400 font-bold">{req.icon}</span>
                ...
                <div className="relative bg-white dark:bg-slate-800 rounded-2xl p-8 md:p-10 shadow-2xl border border-slate-100 dark:border-slate-700">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2.5 group">
                      ...
                      <div className="relative">
                        <FiLock className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 dark:text-slate-500 group-focus-within:text-teal-600 transition-colors" size={20} />
                        <input
                          ...
                          className={`w-full px-4 py-3.5 pl-12 pr-12 rounded-xl border-2 transition-all duration-300 outline-none ${
                            errors.password && touchedFields.password
                              ...
                              : 'border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 focus:border-teal-500'
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="w-full py-3.5 md:py-4 px-4 rounded-xl font-bold text-white bg-primary-600 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                    >
                      {loading ? (
                        <>
