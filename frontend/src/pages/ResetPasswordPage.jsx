      ...
      <MainLayout>
        <div className="relative min-h-screen w-full overflow-hidden pt-20 pb-12">
          <div className="absolute inset-0 -z-10">
            ...
            <div className="absolute bottom-0 left-0 w-96 h-96 bg-[#14b8a6] rounded-full blur-3xl animate-pulse" />
          </div>
          ...
          <div className="max-w-md mx-auto px-4 flex items-center justify-center min-h-[calc(100vh-200px)]">
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-2xl text-center">
              ...
              <button
                ...
                className="w-full py-3 px-4 rounded-xl font-bold text-white bg-[#14b8a6] transition-all"
              >
                Request New Link
              </button>
            </div>
        ...
        <div className="relative min-h-screen w-full overflow-hidden pt-20 pb-12">
          ...
          <div className="max-w-md mx-auto px-4 flex items-center justify-center min-h-[calc(100vh-200px)]">
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-2xl text-center animate-in fade-in">
              <div className="w-20 h-20 bg-[#14b8a6] rounded-full flex items-center justify-center shadow-lg mx-auto mb-6">
              ...
              <button
                ...
                className="w-full py-3 px-4 rounded-xl font-bold text-white bg-[#14b8a6] transition-all flex items-center justify-center gap-2"
              >
                ...
                <div className="relative bg-white dark:bg-slate-800 rounded-2xl p-8 md:p-10 shadow-2xl border border-slate-100 dark:border-slate-700">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="w-full py-3.5 md:py-4 px-4 rounded-xl font-bold text-white bg-[#14b8a6] transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                    >
                      {loading ? (
                        <>
