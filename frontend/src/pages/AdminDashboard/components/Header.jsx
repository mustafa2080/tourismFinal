        ...
        <div className="flex items-center justify-between h-16 sm:h-18 md:h-20 gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
            ...
            <div className="relative hidden md:block">
              ...
              {notificationsOpen && (
                <div className="absolute top-full right-0 mt-2 w-96 bg-white dark:bg-slate-800 rounded-xl shadow-2xl border border-slate-200 dark:border-slate-700 overflow-hidden z-50">
                  <div className="p-4 bg-[#0d9488] border-b border-slate-200 dark:border-slate-700">
            ...
            <div className="relative">
              ...
              >
                <div className="w-9 h-9 rounded-full bg-[#0d9488] flex items-center justify-center text-white text-sm font-bold shadow-md flex-shrink-0 overflow-hidden">
                  {profileImageUrl ? (
                    <img 
                      src={profileImageUrl}
                      alt={user?.name}
