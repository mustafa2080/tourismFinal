...
export function ReviewsPage() {
  ...
  const StatCard = ({ icon: Icon, label, value, color }) => (
    <div className={`bg-[#14b8a6] ${color} rounded-xl shadow-lg p-6 text-white border border-opacity-20 group hover:shadow-xl transition-all duration-300 transform hover:scale-105`}>
  ...
  return (
    <div className="space-y-6 pb-8">
      ...
      <div className="bg-[#14b8a6] rounded-xl shadow-lg p-6 border border-slate-200 dark:border-slate-700">
            ...
            >
              <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-4">
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-12 h-12 rounded-full bg-[#14b8a6] flex items-center justify-center text-white font-bold shadow-lg">
                ...
                <div className="flex flex-col items-end gap-3">
                  <button
                    ...
                    className="px-4 py-2 bg-[#14b8a6] text-white rounded-lg text-sm font-bold transition-all shadow-md hover:shadow-lg flex items-center gap-2"
                  >
                    <FiX size={16} />
                    Delete
                  </button>
              ...
              <div className="flex justify-end pt-4 border-t border-slate-200 dark:border-slate-700">
                <button
                  ...
                  className="px-6 py-2.5 rounded-lg bg-[#14b8a6] text-white font-semibold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
                >
                  Review Details
                </button>
              </div>
      ...
      {showModal && selectedReview && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl max-w-3xl w-full border border-slate-200 dark:border-slate-700 overflow-hidden animate-in fade-in scale-95 duration-200">
            {/* Modal Header */}
            <div className="flex items-center justify-between p-4 sm:p-6 lg:p-8 bg-[#14b8a6] text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 p-4 sm:p-6 lg:p-8 bg-slate-50 dark:bg-slate-700/50 border-t border-slate-200 dark:border-slate-700">
              <button
                ...
                className="flex-1 px-6 py-3 rounded-lg bg-[#14b8a6] text-white transition-all font-bold flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transform hover:scale-105"
              >
