    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[#ED9A58] mb-4">
    ...
    <div className="space-y-8 pb-10">
      ...
      <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
        <div>
          <div className="flex items-center gap-3 mb-2">
            <div className="p-3 bg-[#ED9A58] rounded-xl shadow-lg">
              <FiTrendingUp className="text-white" size={28} />
            </div>
            <div>
              <h1 className="text-4xl font-bold bg-[#ED9A58] bg-clip-text text-transparent">
                Bookings Management
              </h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          const gradientClass = `bg-[#ED9A58] ${stat.color}`;
          return (
            <div key={idx} className="group stat-card bg-white dark:bg-slate-800 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700 overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className={`p-3 bg-[#ED9A58] ${stat.color} rounded-lg shadow-md group-hover:scale-110 transition-transform`}>
                    <Icon className="text-white" size={20} />
                  </div>
                </div>
                <div className={`text-4xl font-bold bg-[#ED9A58] ${stat.color} bg-clip-text text-transparent`}>
                  {stat.value}
                </div>
              </div>
            </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between p-6 gap-6">
                  ...
                  <div className="flex flex-col gap-3 md:min-w-[200px]">
                    <button
                      ...
                      className="flex items-center justify-center gap-2 px-6 py-3 bg-[#ED9A58] text-white rounded-xl transition-all font-semibold shadow-md hover:shadow-lg transform hover:scale-105"
                    >
                      <FiEye size={18} />
                      View Details
                    </button>
      ...
      {bookings.length > pagination.limit && (
        <div className="flex items-center justify-between bg-white dark:bg-slate-800 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700 p-6">
          ...
          <button
            ...
            className="flex items-center gap-2 px-6 py-3 bg-[#ED9A58] text-white rounded-xl disabled:opacity-50 disabled:cursor-not-allowed transition-all font-semibold"
          >
            Next →
          </button>
        </div>
      ...
      {showModal && selectedBooking && (
        <div className="modal-overlay fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
          <div className="modal-content bg-white dark:bg-slate-800 rounded-3xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl custom-scrollbar">
            {/* Modal Header */}
            <div className="sticky top-0 bg-[#ED9A58] px-8 py-6 flex items-center justify-between">
              <div>
            ...
            <div className="p-8 space-y-6">
              {/* Status Overview */}
              <div className={`rounded-2xl p-6 bg-[#ED9A58] ${getStatusConfig(selectedBooking.status).color}`}>
