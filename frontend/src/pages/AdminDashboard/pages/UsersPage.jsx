      ...
      <div className="space-y-4">
        ...
        {!loading && (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {/* Total Users */}
            <div className="bg-[#14b8a6] rounded-lg p-4 border border-teal-200 dark:border-teal-800">
            ...
            {/* Customers */}
            <div className="bg-[#14b8a6] rounded-lg p-4 border border-green-200 dark:border-green-800">
              <div className="flex items-center justify-between">
                <div>
            ...
            {/* Admins */}
            <div className="bg-[#14b8a6] rounded-lg p-4 border border-orange-200 dark:border-orange-800">
              <div className="flex items-center justify-between">
                <div>
            ...
            {/* Banned Users */}
            <div className="bg-[#14b8a6] rounded-lg p-4 border border-red-200 dark:border-red-800">
              <div className="flex items-center justify-between">
                <div>
              ...
              {filteredUsers.map((user) => (
                <div key={user.id} className="p-4 sm:p-5 space-y-3">
                  <div className="flex items-center gap-3">
                    <div className="w-11 h-11 rounded-full bg-[#14b8a6] flex items-center justify-center text-white text-sm font-bold flex-shrink-0">
                  ...
                  {filteredUsers.map((user, index) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 rounded-full bg-[#14b8a6] flex items-center justify-center text-white text-sm font-bold flex-shrink-0">
                            {user.name?.[0]?.toUpperCase() || 'U'}
                          </div>
      ...
      {showModal && selectedUser && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-slate-800 rounded-xl shadow-2xl max-w-md w-full border border-slate-200 dark:border-slate-700 overflow-hidden animate-in fade-in">
            {/* Modal Header */}
            <div className="flex items-center justify-between p-6 border-b border-slate-200 dark:border-slate-700 bg-[#14b8a6] ">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex justify-center mb-2">
                <div className="w-16 h-16 rounded-full bg-[#14b8a6] flex items-center justify-center text-white text-2xl font-bold shadow-lg">
