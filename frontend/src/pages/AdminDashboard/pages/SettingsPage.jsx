...
export function SettingsPage() {
  ...
  return (
    <div className="space-y-8 pb-10">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
        <div className="bg-[#14b8a6] px-6 py-5 border-b border-slate-200 dark:border-slate-700 flex items-center gap-3">
      ...
      {/* Email Configuration */}
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
        <div className="bg-[#14b8a6] px-6 py-5 border-b border-slate-200 dark:border-slate-700 flex items-center justify-between">
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            {getAvailableLanguages().map((lang) => (
              <div key={lang.code} className="p-4 rounded-xl bg-[#14b8a6] border-2 border-teal-200 dark:border-teal-700 text-center hover:shadow-lg transition-all">
 ...
 className="flex items-center justify-center gap-3 px-6 py-3 bg-[#14b8a6] text-white rounded-xl disabled:opacity-50 disabled:cursor-not-allowed transition-all font-semibold shadow-md hover:shadow-lg"
 >
 <FiRefreshCw size={18} className={fillingTranslations ? 'animate-spin' : ''} />
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <button
          ...
          className="flex-1 flex items-center justify-center gap-3 px-6 py-4 bg-[#14b8a6] text-white rounded-xl disabled:opacity-50 disabled:cursor-not-allowed transition-all font-bold shadow-lg hover:shadow-xl transform hover:scale-105"
        >
          <FiSave size={22} />
