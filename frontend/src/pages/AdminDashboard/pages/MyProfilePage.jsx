  ...
  return (
    <div className="space-y-8 pb-10">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
        <div className="bg-[#0d9488] px-6 md:px-8 py-8">
          <div className="flex flex-col md:flex-row items-center gap-6">
            {/* Avatar */}
            <div className="relative group">
              <div className="w-24 h-24 rounded-full bg-[#0d9488] flex items-center justify-center text-white text-4xl font-bold shadow-lg flex-shrink-0 overflow-hidden">
                {avatarPreview ? (
                  <img 
                    src={avatarPreview} 
          ...
          {editing && (
            <div className="flex gap-4 mt-8">
              <button
                ...
                disabled={loading}
                className="flex-1 flex items-center justify-center gap-3 px-6 py-4 bg-[#0d9488] text-white rounded-xl disabled:opacity-50 disabled:cursor-not-allowed transition-all font-bold shadow-lg"
              >
                <FiSave size={22} />
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
        <div className="bg-[#0d9488] px-6 md:px-8 py-5 border-b border-slate-200 dark:border-slate-700">
