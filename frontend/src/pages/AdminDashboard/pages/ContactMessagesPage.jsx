...
export function ContactMessagesPage() {
  ...
  const getStatusBadgeColor = (status) => {
    switch (status) {
      case 'pending':
        return 'bg-[#0d9488] text-amber-700 dark:text-amber-300 border border-amber-200 dark:border-amber-800/30';
      case 'read':
        return 'bg-[#0d9488] text-teal-700 dark:text-teal-300 border border-teal-200 dark:border-teal-800/30';
      case 'responded':
        return 'bg-[#0d9488] text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800/30';
      default:
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900 p-4 md:p-6 lg:p-8">
      <div className="space-y-6 max-w-7xl mx-auto">
        {/* Header Section */}
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="space-y-1">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold bg-[#0d9488] bg-clip-text text-transparent">
              Contact Messages
            </h1>
          ...
          <button
            ...
            className="group flex items-center justify-center gap-2 px-6 py-3 bg-[#0d9488] text-white font-semibold rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 active:scale-95"
          >
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className={`bg-[#0d9488] ${stat.color} p-3 rounded-xl transform group-hover:scale-110 transition-transform`}>
            ...
            {loading ? (
              <div className="flex flex-col items-center justify-center h-96">
                <div className="relative w-16 h-16 mb-4">
                  <div className="absolute inset-0 bg-[#0d9488] rounded-full animate-spin" style={{maskImage: 'radial-gradient(farthest-side, transparent calc(100% - 4px), black calc(100% - 4px))'}}></div>
                </div>
              ...
              <div className="flex flex-col items-center justify-center h-96 bg-white dark:bg-slate-800/50 backdrop-blur-xl rounded-xl border border-gray-200/50 dark:border-slate-700/50">
                <div className="bg-[#0d9488] p-6 rounded-full mb-4">
 ...
 ? 'bg-[#0d9488] border-teal-300 dark:border-teal-700/50 shadow-lg'
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-3 mb-2 flex-wrap">
                          <div className="flex items-center gap-2">
                            <div className="w-8 h-8 bg-[#0d9488] rounded-lg flex items-center justify-center text-white font-bold text-sm">
                ...
                <div className="p-6 space-y-2 bg-gray-50 dark:bg-slate-700/20">
                  {selectedMessage.status !== 'read' && (
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-[#0d9488] text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-md hover:shadow-lg"
                    >
