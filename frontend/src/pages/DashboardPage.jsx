...
const DashboardPage = () => {
 ...
 : 'text-slate-600 dark:text-slate-400 border-transparent hover:text-slate-900 dark:hover:text-white'
            ...
            {activeTab === 'overview' && (
              <div className="space-y-8">
                {/* Welcome Header */}
                <div className="bg-primary-600 rounded-2xl p-6 md:p-8 text-white shadow-lg overflow-hidden relative group">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-sm border border-slate-200 dark:border-slate-700 hover:shadow-xl hover:border-teal-300 dark:hover:border-teal-600 transition-all duration-300 group">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="p-2 md:p-4 bg-primary-600 rounded-xl shadow-lg group-hover:shadow-xl transition-all duration-300 transform group-hover:scale-110 flex-shrink-0">
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 md:p-8 shadow-sm border border-slate-200 dark:border-slate-700">
                  ...
                  <div className="space-y-3">
                    {(Array.isArray(bookings) ? bookings : []).slice(0, 5).map((booking) => (
                      booking && (
                      <div key={booking.id} className="flex items-center justify-between p-3 md:p-4 hover:bg-primary-600 rounded-xl transition-all border border-slate-200 dark:border-slate-700/50 group cursor-pointer flex-col md:flex-row gap-3 md:gap-4">
 ...
 'bg-orange-100 dark:bg-orange-900/30'
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                  {/* Saved Trips */}
                  <div className="bg-primary-600 rounded-2xl p-6 md:p-8 border border-orange-200 dark:border-orange-700/50 hover:shadow-lg hover:border-orange-300 dark:hover:border-orange-600 transition-all duration-300 group">
                  ...
                  {/* Explore More */}
                  <div className="bg-primary-600 rounded-2xl p-6 md:p-8 border border-teal-200 dark:border-teal-700/50 hover:shadow-lg hover:border-teal-300 dark:hover:border-teal-600 transition-all duration-300 group">
                    <div className="flex items-start justify-between mb-6">
                      <div>
            ...
            {activeTab === 'bookings' && (
              <div className="space-y-6">
                {/* Header with summary */}
                <div className="bg-primary-600 text-white rounded-xl p-4 md:p-6 mb-6">
                ...
                {filteredBookings.length === 0 ? (
                  <div className="bg-white dark:bg-slate-800 rounded-xl p-12 text-center border-2 border-dashed border-slate-200 dark:border-slate-700">
                    ...
                    {(Array.isArray(bookings) ? bookings : []).length === 0 && (
                      <button
                        onClick={() => navigate('/search')}
                        className="inline-flex items-center gap-2 px-6 py-3 bg-primary-600 text-white font-bold rounded-lg hover:shadow-lg transition-all"
                      >
                        <FiSearch size={18} />
                        Explore Packages
                      </button>
            ...
            {activeTab === 'stats' && (
              <div className="space-y-4 md:space-y-6">
                {statsLoading ? (
                  ...
                  <>
                    {/* Stats Header */}
                    <div className="bg-primary-600 rounded-xl p-4 md:p-6 text-white">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
                      ...
                      <div className="bg-white dark:bg-slate-800 rounded-xl p-4 md:p-6 shadow-sm border border-slate-200 dark:border-slate-700 hover:shadow-lg transition-all group">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="p-2 md:p-4 bg-primary-600 rounded-xl group-hover:scale-110 transition-transform flex-shrink-0 ml-2">
 ...
 : 'bg-red-50 dark:bg-red-900/20 border-red-500'
                ...
                {wishlistLoading ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {wishlist.filter(item => item !== null && item !== undefined).map((item) => {
                      ...
                      >
                        {/* Image */}
                        <div className="relative h-40 md:h-48 bg-primary-600 overflow-hidden">
                          {imageUrl ? (
                            <img
                              src={imageUrl}
                              alt={title}
                        ...
                        <div className="p-3 md:p-6">
                          ...
                          <button
                            ...
                            className="w-full flex items-center justify-center gap-1.5 md:gap-2 px-3 md:px-4 py-2 md:py-3 bg-primary-600 text-white font-bold rounded-lg transition-all hover:shadow-lg text-sm md:text-base"
                          >
            ...
            {activeTab === 'profile' && (
              <div className="max-w-5xl space-y-4 md:space-y-6">
                ...
                <div className="relative overflow-hidden rounded-2xl bg-primary-600 shadow-xl">
                    ...
                    <div className="flex flex-col md:flex-row items-center md:items-end gap-4 md:gap-6 lg:gap-8">
                      ...
                      <div className="relative flex-shrink-0 group">
                        <div className="relative w-28 md:w-32 lg:w-40 h-28 md:h-32 lg:h-40 rounded-3xl overflow-hidden">
                          <div className="absolute inset-0 bg-primary-600 rounded-3xl border-2 md:border-4 border-white/40 backdrop-blur-sm"></div>
                          {avatarPreview ? (
                  ...
                  <div className="flex justify-between items-start mb-6 md:mb-8 flex-col md:flex-row gap-4">
                    ...
                    {!isEditingProfile && (
                      <button
                        ...
                        className="hidden sm:flex items-center gap-2 px-4 md:px-6 py-2 md:py-3 bg-primary-600 text-white font-bold rounded-lg transition-all hover:shadow-lg hover:scale-105 text-sm md:text-base flex-shrink-0"
                      >
 ...
 : 'border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-700/50 cursor-default'
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-6 pt-4 md:pt-8 border-t border-slate-200 dark:border-slate-700">
                      <div className="bg-primary-600 rounded-xl p-4 md:p-5 border border-green-200 dark:border-green-800/50">
                      ...
                      <div className="bg-primary-600 rounded-xl p-4 md:p-5 border border-teal-200 dark:border-teal-800/50">
                        <div className="flex items-center gap-2 md:gap-3 mb-1.5 md:mb-2">
                    ...
                    <div className="pt-6 md:pt-8 border-t border-slate-200 dark:border-slate-700 flex flex-col gap-2 md:gap-3">
                      {isEditingProfile ? (
                        ...
                        <>
                          <button
                            onClick={() => setIsEditingProfile(true)}
                            className="sm:hidden flex-1 flex items-center justify-center gap-2 px-4 py-2.5 md:py-3 bg-primary-600 text-white font-bold rounded-xl transition-all hover:shadow-lg active:scale-95 group text-sm md:text-base"
                          >
                          ...
                          <button
                            ...
                            className="flex-1 flex items-center justify-center gap-2 px-4 md:px-6 py-2.5 md:py-3.5 bg-primary-600 text-white font-bold rounded-xl transition-all hover:shadow-lg hover:scale-105 active:scale-95 group text-sm md:text-base"
                          >
                ...
                {/* Danger Zone */}
                <div className="bg-primary-600 border-2 border-red-200 dark:border-red-800/50 rounded-2xl p-4 md:p-6 shadow-lg">
