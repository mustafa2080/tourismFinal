      ...
      <div className="min-h-screen bg-[#14b8a6] flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 text-center py-24">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-[#14b8a6] text-white font-semibold rounded-lg hover:shadow-lg transition-all"
          >
  ...
  return (
    <div className="min-h-screen bg-[#14b8a6] flex flex-col">
      ...
      <article className="flex-1">
        {/* Cover image */}
        <div className="w-full h-64 sm:h-80 md:h-96 bg-[#14b8a6] relative overflow-hidden">
          {post.featured_image && (
            <img
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                {related.map((r) => (
                  ...
                  >
                    <div className="h-32 bg-[#14b8a6] overflow-hidden">
                      {r.featured_image && (
