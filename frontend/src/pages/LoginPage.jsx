          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[calc(100vh-200px)]">
            ...
            <div className="w-full animate-in fade-in slide-in-from-right-8 duration-700">
              ...
              <div className="relative">
                ...
                <div className="absolute -inset-0.5 bg-[#0d9488] rounded-2xl blur opacity-0 group-hover:opacity-100 transition duration-1000 group-hover:duration-200" />
                ...
                <div className="relative bg-white dark:bg-slate-800 rounded-2xl p-8 md:p-10 shadow-2xl border border-slate-100 dark:border-slate-700">
                  ...
                  <div className="text-center mb-8 space-y-3">
                    <div className="flex justify-center">
                      <div className="relative w-16 h-16 bg-[#0d9488] rounded-xl flex items-center justify-center shadow-lg shadow-teal-500/30 group">
                  ...
                  <button
                    ...
                    className="w-full py-3.5 md:py-4 px-4 rounded-xl font-bold text-slate-900 dark:text-white bg-[#0d9488] transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg"
                  >
                    Create Account
                  </button>
                </div>
