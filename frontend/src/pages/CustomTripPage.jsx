...
const CustomTripPage = () => {
          ...
          <div className="max-w-lg w-full bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                ...
                className="flex-1 px-5 py-2.5 bg-[#0d9488] text-white font-semibold rounded-xl transition-all"
              >
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 flex flex-col">
      ...
      {/* Hero */}
      <section className="relative pt-10 pb-8 px-4 sm:px-6 lg:px-8 bg-[#0d9488] ">
 ...
 activeItemType === type
 ? 'bg-gradient-to-r from-teal-600 to-teal-600 text-white shadow-sm'
                        ...
                        <div className="p-3.5">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <button
                              type="button"
                              onClick={() => addItem(opt)}
                              className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-teal-50 dark:bg-teal-900/20 text-teal-600 dark:text-teal-400 text-xs font-bold hover:bg-teal-100 dark:hover:bg-teal-900/40 transition-all"
                            >
                              <FiPlus size={12} />
                              Add
                            </button>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 rounded-xl border-2 border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-white focus:outline-none focus:border-teal-500"
                    />
                  </div>
                </div>
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-2.5 rounded-xl border-2 border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-white focus:outline-none focus:border-teal-500 resize-none"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-5 sticky top-36">
                ...
                <button
                  ...
                  disabled={submitting}
                  className="w-full flex items-center justify-center gap-2 px-5 py-3 bg-[#0d9488] disabled:opacity-60 text-white font-bold rounded-xl transition-all shadow-md"
                >
                  {submitting ? (
                    <>
        ...
        {step < 4 && (
          <div className="flex items-center justify-between mt-6">
            ...
            <button
              type="button"
              onClick={goNext}
              className="flex items-center gap-1.5 px-6 py-2.5 rounded-xl font-bold text-sm text-white bg-[#0d9488] shadow-md hover:shadow-lg transition-all"
            >
              Continue
