  ...
  return (
    <MainLayout>
      <div className="min-h-screen bg-[#14b8a6] ">
        {/* Progress Bar */}
        <div 
          className="fixed top-0 left-0 h-1.5 bg-[#14b8a6] z-50 transition-all duration-300" 
 ...
 : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-700'
            ...
            <div className="lg:col-span-4 space-y-8">
              ...
              <section className="scroll-mt-20">
                <div className="bg-[#14b8a6] rounded-2xl p-8 border-2 border-green-200 dark:border-green-800 shadow-sm hover:shadow-md transition-all">
