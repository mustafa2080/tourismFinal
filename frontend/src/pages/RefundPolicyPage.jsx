  ...
  return (
    <MainLayout>
      <div className="min-h-screen bg-white dark:bg-slate-900 ">
        {/* Progress Bar */}
        <div 
          className="fixed top-0 left-0 h-1.5 bg-[#0d9488] z-50 transition-all duration-300" 
 ...
 : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-700'
            ...
            <div className="lg:col-span-4 space-y-8">
              ...
              <section id="exceptions" className="scroll-mt-20">
                <div className="bg-white dark:bg-slate-800/50 rounded-2xl p-8 border border-gray-200 dark:border-slate-700 shadow-sm hover:shadow-md transition-all">
                  <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-8 flex items-center gap-3">
                    <AlertTriangle size={32} className="text-teal-600 dark:text-teal-500" />
                    Special Circumstances
                  </h2>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={idx} className="bg-gray-50 dark:bg-slate-700/50 rounded-lg p-4 border-2 border-gray-200 dark:border-slate-600 hover:border-teal-500 dark:hover:border-teal-500 transition-all">
              ...
              <section className="scroll-mt-20">
                <div className="bg-[#0d9488] rounded-2xl p-8 border-2 border-green-200 dark:border-green-800 shadow-sm hover:shadow-md transition-all">
